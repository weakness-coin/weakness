...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 2022958;
...
For example:
WeaknessCoind --print-genesis-tx --genesis-block-reward-address TRTLv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff00018094ebdc03022a53d65b1df72287dbe6383aa524ea84df792bb7d5c777c34b0850262d619911210135ece9ed84a7513efa087e649f04bb30bf1d8dbc3d3125b6f6e38222f7a0ba6c";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in WeaknessCoind. It is used to know what timestamp
...
/* The mixin to use by default with zedwallet and weakness-service */
...
const uint32_t UPGRADE_HEIGHT_V5                             = 1200000; // Upgrade height for CN-Weakness Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "WeaknessCoin";
...
const char     LATEST_VERSION_URL[]                          = "http://latest.weakness-coin.com";
const std::string LICENSE_URL                                = "https://github.com/weaknesscoin/weaknesscoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb5, 0x0c, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc1, 0x43, 0xe8  }
};

const char* const SEED_NODES[] = {
  "80.211.110.146:11897",//rock
  "80.211.48.42:11897"
};
} // CryptoNote
